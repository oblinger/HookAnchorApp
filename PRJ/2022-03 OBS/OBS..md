...
## LATER
- [ ] BUG -  fix auto generator to create wiki links (convert to URL encoding to handle spaces)
...
- AUTO INSERT -- 
### OBS-PUBLISH
- Auto upload pandoc output to be viewed (potentially with password)

- [ ] OBS:  Change styling of published pages
- [ ] OBS: Publish clean looking web content automatically from markdown

### KM -T (topics)
- [ ] BUG:  km recognized the '@sports visio' topic page, but then did not link all people docs in the folder

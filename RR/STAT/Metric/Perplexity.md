Perplexity;;measures the average number of choices the model has for predicting the next word (entropy of next word prediction) <!--SR:!2026-02-19,219,270-->

Perplexity Formula
-?-
Perplexity =  2^{H(p)}.  where H(p) is the entropy of the probability distribution \( p \), which can be computed as:
H(p) = - \frac{1}{N} \sum_{i=1}^{N} \log_2 p(x_i) <!--SR:!2026-02-05,205,270-->

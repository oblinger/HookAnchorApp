...
.
Stable version:   softmax(z) = e^(z-max(z)) / Σ e^(z-max(z)) <!--SR:!2025-07-16,1,250-->
...
Tanh
-?-
Similar to sigmoid but outputs between -1 and 1, useful for zero-centered data. <!--SR:!2025-07-16,1,215-->
...
Leaky ReLU
-?-
Leaky Rectified Linear Unit:  F(x) = x if x>0 else alpha*x <!--SR:!2026-02-19,219,270-->

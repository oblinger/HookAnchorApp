...
### ✅ Commands Database (`commands.txt`)
- **Never overwrites existing commands**
- Analyzes existing file for user content (non-comment lines)
- If has commands: Preserves completely untouched
- If empty/comments only: Creates backup, adds starter examples
- Only creates new file if none exists

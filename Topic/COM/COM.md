.[[COM]].
  ...
  , [COMS Conferences Obsidian](spot://comsconferencesobsidian), 
...
— https://www.linkedin.com/in/kellykinnard/
Venture Cap Firms
Find other fraction CTOs
...
-- ML curriculum
-- Lined up calls
-- https://www.linkedin.com/in/yaroslav-bulatov-862b3b1/


Where am I going?  

Corp:			Ben Wild, Theo Enns, 
				Decoste, Hellerstein
AI-CENTERS:  	OpenAI, Miri, 
...
— Eyal Amir
— Neil Keller
Alex Avendano.  alex@robocore.systems
-- Russ
-- Sam
-- Brodie
-- Andrea
-- Freed (in Feb)
-- Josh from Hackers
-- Paul Go (friend from Atilla); PATRICK nick friend; LISP
-- Cristina
-- Meet Raynor at the dog park
-- Nick & friend -- beer about calculating F-U money
...
-- Dave O
-- Wicktor . anita@netguru.com
-- Nate
-- Chris Langdon (from illinois linkedin)
-- Zvi from linked in
-- Jazz, Sammie, Zuly
-- Doug Gordin
-- brodie

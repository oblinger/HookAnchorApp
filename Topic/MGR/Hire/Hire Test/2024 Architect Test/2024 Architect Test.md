...
Part I: Design a stand alone Game Scheduling System.  The candidate will
- Spend up to 20 minutes reading rough task description
- Then up to 20 minutes in discussion with our head of product agreeing on approach.
- Then 2-4 hours designing a product spec and system approach for addressing this customer need.  The spec should include:
	- A list of all users flows required for this system.
	- A full specification of two flows (pictures not required)
	- A design of the backend (a) tables, (b) apis, and (c) classes required to drive the front end.
	- A discussion of any complexities in implementation along with proposed solutions.

Part II: We provide a spec for a simplified Game Scheduling System to be implemented.
- Candidate delivers MVP system for demonstrating the basic backend capability.
- Candidate delivers Unit tests that validate the basic functioning of the backend.

...
## 2025-11-14  My Priorities

Here are my preferences:
BigCo AI Leader > Eng Mgr > StartupCTO > Consultant

- No idea if an AI-leader role is plausible
- I could hate the stress of the AI-leader role but the pay is double, and I'm probably good at it.
- Consultant is probably the best path to Eng Mgr
- If SV gets its A-round in June I am pretty safe for 2+ years, but salary 
...
Trying to implement [[HABIT SAVERS]] habit
...
- Caused next day to be productive too (maybe)
- Pushed to get range of home project done by end of day on Monday.  again felt good and was productive.


Generally before I was not getting time on impt stuff, but when I do, real progress is made
...
==> I need to pick items to 'finish' at least to some specific level of done.  then do it!
...
- **EFFECTIVE** - For the first time in a long time I feel like I am being particularly effective with my time.  Why?
	- DELEGATE - I quickly cut to the nub of many issues, so I can delegate quickly.  and I LIKE delegating.
	- FIREHOSE - I like surfing many different issues, and putting bits of high value time against them.
	- CAT - I get to choose which task I will add value, how and when.
	- TEMPO - stuff happening is at a high tempo; it puts me into a high tempo

- **MY VALUE** - I went from feeling insecure in what value I might bring to SV, into a mode where it is clear of the value that I can bring on a sustained basis, and how I am able to "level up" my value, by getting to the top of the pyramid in all areas:
	- Low-hours, high-coverage tracking of ALL of SW Execution
	- Occasional collaborative creation of processes across ALL of SW and ALL of the Company
	- Investor Relations, Fund raising, 
	- Planning/Managing/Execution/Delivery of high value planning, and projects  (e.g. Bridge Round Prep)


I think/hope I can quickly become super time efficient at juggling many balls and have spare time/energy for growth and other things.
Controlling my time & deliveries is key to delivering high value & having spare energy/time

This job is fun, and jobs like this will continue to be fun.

Maybe I supplement this job to make a high income?

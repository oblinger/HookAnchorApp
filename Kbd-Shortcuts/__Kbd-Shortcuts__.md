...
#_/' '  Open Spotlight in the Finder – Command+Option+Space
...
#ENT  Open to location of first search item in Finder – Command+Return
#I    INFO -- Get Info on search item – Command+I
      Show Quick Look Preview of Spotlight results – Command key or hover with the Mouse cursor (OS X 10.7 and later only)
#_/   Show path/location of search result – Command+Option while hovering over search result
#^/v  Jump categories in search results
...
# PRODUCTIVITY APPS
## 1Password
 #\_  \  Show Password mini
 #    \  Fill in password on current page
 ^#\_ \  LOCK 1passord
...
## Cobook
  #N / #DEL   Create / Delete contact
  #L          Toggle edit mode
  #M          Merge
  #E / #D     Email / Dial contact

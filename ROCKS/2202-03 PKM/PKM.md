...
- ONE NAMESPACE -- Critical that all "G" pages exist within one namespace.  Many Gs will have info in many different places, formats, and kinds.  All that stuff must be in one G-"Place" so it can be access

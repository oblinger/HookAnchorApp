# 95-Assistant.Todos --
    ...
    TODO: 
    - VINNY Allow multiple DB access. 
    - rules 
      @internet 
      @ gw 
      @ gw3 
    ...
    dddddd*df$  -->  asdsad$sdfds 
     
    <<>> research 
    <<>> 
     
    [[TODO]] 
    . strip puns from serarch term 
    . Force synchronization on AssistantDB and ??CCAssistant?? 
    . Better notes 4.6 or later message in loader. 

...
- GREEN HOUSE FARMING - As you mentioned such businesses are easier to fund since they are more reliable, and I expect that there is notable skill and cash needed to setup a green house and then maximize every square meter of its output for maximum profit.  I bet this is an area where cash and training can have large value.  I also bet this is a business where it would be reasonable to create a 20 or 100 person shared corp - I think the size of the business might be good.  
  ...
  At this stage it would be super useful to have ANY kinds of numbers about what the setup costs would be, and what kind of revenue was plausible.  I am not trying to build the actual business case here; rather I would just love to have some 'kind-of' real numbers in a simple table so that when I speak about this idea I have at least one business where I have very basic numbers that show the idea at least as potential.
...
### m2022-06-30  First discussion about EduCorp
...
Tomato Factory - but they don't have a guarantee 

- Risks are high and the returns do not come immediately.

~
- coconut plantations.  
- expensive to transport  100/day per farmer
- less risk, a bit more profitable

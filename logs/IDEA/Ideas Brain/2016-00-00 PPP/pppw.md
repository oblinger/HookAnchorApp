...
testing _underscores_ and *stars* and UPPERCASE __doubleunderscores__ **doublestars**
_*understar*_ as well
...
ROOT -- The 'toplevel' outter most structured form in some structured expression.  All structued expressions have one root form:  head( value_1, value_2 ..., key_a=value_a, key_b=value_b, ...)
...
obj( HEAD_SYMBOL, SPEC1, SPEC2, ..., key_a=SPEC_A, key_b=SPEC_B, varargs=SPEC, keyargs=SPEC )

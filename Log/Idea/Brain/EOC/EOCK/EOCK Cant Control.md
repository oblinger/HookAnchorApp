...
**Humanity will be unable to maintain indefinite control over the ASI systems it creates**

**Executive Summary** - Even if the challenging objective of building ASI systems aligned to the purposes that humanity intends, we will still ultimately be at the mercy of these ASI systems once they are created, along with other unaligned ASI systems.  Further, since "shit happens" no matter how carefully humanity strives to set the initial conditions of this ecosystem, a variety of pressures will evolve it significantly beyond that point.  Whatever happens, humanity will not be in control of this evolution. Instead, a competing collection of ASIs will be.

**Caveats** — It is helpful to frame this conclusion first in terms of what is NOT being claimed, both to minimize the non-trivial alarm they cause and to increase the believability of the argument itself by carefully avoiding unintended overreach.
- ALIGNMENT MAY BE POSSIBLE--We are not arguing that it is impossible to construct an ASI that is aligned to a purpose intended by its creators.  We are more skeptical on this point, but it is still conceivable that an ASI could be constructed that guarantees it remains aligned even as it evolves itself indefinitely into the future.  Our argument here is to notice several intrinsic properties of the system as a whole will conspire to break any such alignment guarantees in the long run.
...
- AGI is possible, and we are on track to achieve it (see [[EOCK AGI Will Come]]).
- Further, ASI will soon follow (see [[EOCK AGI implies ASI]]).
- The world (people, corporations, and nations) operates within competitive ecosystems they cannot escape (see [[EOCK Corp AI]]).
- Consequently, we cannot stop the construction of ASI systems (see [[EOCK Cant Stop]]).
...
See [[EOCK Corp AI]] for an extended discussion of the nature of these competitive environments, particularly as they apply to the emergence of AI-based competition.

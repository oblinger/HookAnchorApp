...
- PERCEPTION STACK - A [[VAEs]] stack.  In additional to optimally reconstructing the original inputs, the system is optimized to provide needed distinctions for remainder of the brain.
...
- 3D-KINOMATIC
	...
	- Hieararchical Spatial Segmentation
	- Temporal Segmentation
	- Hierarchical Temporal Segmentation
	- Functional Modelling
	- 2D-3D Projective and Abductive mappings

...
Patients are beginning to self-administer medical care at home using printed instructional materials.

Correct usage of 

PROBLEM:
Supplement printed medical-device instructional material with AR-tech that simplifies usage and increases correct usage rates.
_
## === GATING QUESTIONS ===
...
#### -- Boston Scientific --
##### - Ask Angie -
Its "Ask Angie" program, for example, provides remote help to customers that are having trouble setting up or operating Boston Scientific's products. The system uses augmented reality from vendor Help Lightning to superimpose an expert's hands over a customer's real-world camera view to help guide the setup of new devices.



##### - B. Sci prepares for virtual appointments -
...
### --- Vendor Companies ---
#### -- Coala --
Virtual diagnostics of heart and lungs

BlueTooth device + smart phone does remote diagnostics

#### -- Help Lightning --

- Merged Reality -- 
Allows remote expert to use pen to indicate parts of remote environment, and to put their hands in front of their camera and show those hands super imposed into remote enviornment.

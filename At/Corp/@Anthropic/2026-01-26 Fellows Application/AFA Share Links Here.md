...
(Over the summer I wrote a 35K line personal knowlege management tool in Rust, Javascript and Swift, it is not open source, but I can share the codebase if relevant)
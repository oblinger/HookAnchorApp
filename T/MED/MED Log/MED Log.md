...
- 10+ day cold; more phlem; sinus drainage. sinus, bronchise,  bad: green grey yellow creme puss looking 
...
artiery narrowing
5'9" images not so good   (
angiogram (
no obvious heart muscle thickening.
Meditranian diet best
...
Examination Performed: A two-dimensional stress echocardiogram was performed. A limited
color and spectral doppler study was performed. Study quality: Adequate.


Exercise Data: The resting blood pressure was normal (140/86 mmHg). The maximum age-
predicted heart rate (MPHR) was 166 bpm. The patient exercised for 7:15 of a 2 min Modified
Bruce protocol. The peak heart rate was 230 bpm. Percent MPHR: 138%. METs Acheived: 12.10. The
blood pressure response to exercise was abnormal (exaggerated 210/86 mmHg).

Resting EKG: Normal sinus rhythm at 75 beats per minute.
Resting Echocardiogram: Normal global systolic function. Estimated EF is 55%. Resting
echocardiographic images demonstrated normal LV diastolic volume. LV wall thickness was
increased. There are no wall motion abnormalities. The color flow Doppler study showed trace
TR. The peak resting TR gradient was 23.0 mmHg.

Post Exercise EKG: SVT in 4th stage of exercise. Test stopped due high SVT heart rate 230
BPM which lasted into recovery. Horizontal to downsloping ST depression in recovery.
Post Exercise Echocardiogram: After exercise as described, there was a symmetric increase in
contraction, with an increased LVEF and decreased LVESV. There is a symmetric decrease in end-
systolic LV volume. No new segmental wall motion abnormalities were noted. The LV wall motion
score index was normal. The post exercise TR gradient could not be accurately measured.
Supervisor: Cardiac Nurse: Alex Valerio, RN. EKG Technologist: Jason Wong-Lima.

MMode/2D Measurements & Calculations
TR max PG: 23.0 mmHg

Doppler Measurements & Calculations
TR max vel: 241.6 cm/sec
...
--  Upstairs sit on toilet.  blood pressure pulsing in eyes.
--  Clubbing -- 
--  Diet:  Salt, weight
...
# Medical\_Journal --
    ...
    -- mild (15db) hearing reduction in the 1-2hz range on left hear
    -- thinks my cough could be 
    ...
    2014 -- Finger tingle.
    - Stressed a bit, second coffee at Philz, 4pm tiny bit cold


    2013 -- Neurologist Lewis

    - Pinky toe numb frequently after brief biking in mild cold
    - Wake with thumb tingling
    - Index finger and numb
    - Clubbing of fingers


    2/10 -- VISION
    Get reading classes at drugstore.  +1.00

    2/27/10 -- Rudsky colonoscopy
    - minimal gastritist

    - no h-pilori
    - no colitis
    - unremarkable 
    - Polyp removed in mid acending colon.  


    gastritis -- is stomach.  inflamation
      h. pylori.   
      burning in stomach, minor discomfort in stomach


    2/5/10 -- Digestive System
    - In Jan-2000 I went to Costa Rica, that was the suspect trip.
    - In 2005 I has a colonoscopy/Endoscopy and discovered and removed h-pylori
    - After that my system was much better.  (much less diareah)
    - Somewhere in 2007?  my system started getting less stable 
    - Went to Amazon in 2008?
    - By 2009 my system is worse.  will go from pasty clay like movements, 
      to lumpy watery, to loose, all the way to just liquid.
    - Dramatic diareea often occurs after eating.
    - Whole grains in the morning might stabalize my system.
    - Second colonoscopy revealed no problems  (TWO POLYPS REMOVED)
    = 2013 -- medifast stabalized system.  coffee, milk, fish, lg steamed veg are all suspect for triggering system
           -- large sugary, grainy

...
### 2025-02-05  Idea:  Use Gemini deep-study



### 2025-02-05  Nick's homework

his homework:
https://docs.google.com/document/d/1mMp2e8I5mAGuFQB71JxgZEJd6MRXOl-m9BEdt-YsjyQ/edit?tab=t.0

His search for companies:
https://docs.google.com/document/d/1dXnZkiK2LFuINTk5eE0uLOpQPzOeUHp-6rS0UbjYDsw/edit?tab=t.0#heading=h.uwn62hqwk0wq
...
FAANGish
Meta		yes	Don't love the mission
Amazon	no		Toxic, slaving
Apple		yes	Quirky hiring
Google		yes	Down hill
Microsoft	?		
...
### 2025-03-10  Old DataView Template


``dataview
TABLE flags as "Flags", stance as "Stance"
FROM ""
WHERE contains(file.path, "NJDB") AND kind = "Big"
SORT file.name
``

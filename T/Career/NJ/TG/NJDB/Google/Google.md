...
#### dlp: 
#### dlproj1: 
Transformer (2017) – novel neural network architecture that became the basis of most modern generative AI models ￼
#### dlproj2: 
LaMDA – family of Transformer-based dialogue models (up to 137B parameters) specialized for open-ended conversation ￼
#### dlproj3: 
PaLM – 540B-parameter Pathways Language Model that significantly advanced state-of-the-art across many NLP and coding tasks via scaling ￼
#### dlproj4: 
Imagen – text-to-image diffusion model with unprecedented photorealism and deep language understanding ￼
#### dlproj5: 
MusicLM – text-to-music generation model producing high-fidelity songs from natural language descriptions ￼
#### dlproj6: 
Magenta – open-source research project exploring machine learning in the creative process (generating art and music) ￼
#### dlproj7: 
Google Duplex – AI system for natural phone conversations that carries out real-world tasks (e.g. making reservations) with human-like speech ￼
#### dlproj8: 
...
### Toxicity
#### toxicity: 8
#### tox_summary: Mostly supportive, recently strained
#### tox_justification: 

...
- Run; Go to extensions page; Download GobanExtensions  (this allows it to play automatically)
- 2023-05-01  (didn't do it, as it is from unidentified developer, but maybe would be ok?)

## xx iStatMenus   (App Store)
### Installation
- Go to page in 1-pass
- Register
...
- Download:  [Download Link](https://paddle.s3.amazonaws.com/fulfillment_downloads/366/491999/FoldingText.dmg). 
- wef234@gmail.com 
- 6BDB5E68-11E68175-22C86242-D73814D1-135F3D9A
...
### INSTALLATION
- Log into https://account.live.com   (with WEF234 account)
- Click on subscription to get to the install page.  then click office for PC or Mac
...
- Download Pycharm, then activate (by using my JB account)
...
Licence Purchased 2023-05-01

----- BEGIN LICENSE -----
Dan Oblinger
Single User License
EA7E-1301292-467502
1E48674E 3DB71168 E6D63D66 D3DE855B
909D6272 6C994B51 B3296B38 2406F8A7
B38CBA0C 89C836FC 390D1279 7F6D9317
8B8C1161 1753C0E6 16CE7F44 519E1838
0A32C078 88170D6B F21267E1 FB2F9673
2843554E BC293A19 45DB9EFE 35BD24EE
5B2BAF83 844E1AFA D55A5C1B A2FC7AF1
C1A234FA 52BC1EF9 83AD0E10 1C3DA103
------ END LICENSE ------
...
- Google "Emacs for Mac OS"   (is not compiled native for mac)
...
## xx Fork   (git visualization tool)

## xx FreeCAD

## xx Flux (CNET)

## xx Finicky  (switcher for default browser)
...
## xx What Size      <<<<< needs update to run on M2
  WHATSIZE7-0001-CRXK-LAKA-PLNY-VFRC-2591-1373
...
## xx Airmail 3
x
## xx Zettlr  (personal Info Manager)

## xx Workflowy

## xx Joplin  (personal info manager)
...
## xx unDock
(app store)
## xx TimeBoxed (broken now)

## xx Timebar

## xx WATCH - JustPressRecord

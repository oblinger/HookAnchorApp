...
.[[CVP]].
  ...
  SLOWER:		[CV Plan](spot://cvplan), [OKRs](spot://okrs), [OKR Slide](spot://okrslide), [AI Prod Matrix](hook://aiprodmatrix),
  DATA:			[CV Planning Folder](spot://cvplanningfolder), [Mgt Gdrive](spot://mgtgdrive),
  ...
  DELS: [CVP Note](spot://cvpnote),[CVP Obsidian](spot://cvpobsidian),[CVP Note](spot://cvpnote),[CVP Note](spot://cvpnote),

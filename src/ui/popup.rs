...
use super::window_utils::{
    save_window_position_with_reason,
    get_previous_window_location, center_on_main_display,
};
...
pub struct AnchorSelector {
    ...
    pub(crate) was_auto_positioned: bool,
...
impl AnchorSelector {
    ...
    pub(crate) fn exit_or_hide(&mut self, ctx: &egui::Context) {
...
// PopupWithControl and run_gui_with_prompt have been moved to popup_server_wrapper.rs

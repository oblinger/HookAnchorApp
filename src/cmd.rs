...
fn print_help_config() {
    ...
    print("  verbose_logging:        true          # Enable detailed logging");
    print("  max_rows:               25            # Max rows in popup grid");
    print("  max_columns:            4             # Max columns in popup grid");
    print("  anchor_timeout_seconds: 3600          # Seconds to remember last anchor");
    print("  run_in_background:      true          # Keep app running for instant popup");
    print("  global_hotkey:          \"Opt-`\"       # Global hotkey (requires accessibility)");
    print("  file_roots:             [\"~/path\"]    # Roots to scan for markdown/apps");
    ...
    print("  obsidian_vault_path:    \"~/vault\"     # Path to Obsidian vault");
    print("");
...
fn print_help_fns() {
    ...
    print("  getObsidianVault()             Get Obsidian vault name");
    print("  getObsidianVaultPath()         Get Obsidian vault path");
    print("  getTmuxStartupCommand()        Get tmux startup command");
    print("");
    print("===============================================================================");
    print("CONFIG.JS FUNCTIONS");
    print("===============================================================================");
    print("");
    print("Defined in ~/.config/hookanchor/config.js (user-editable)");
    print("");
    print("Available functions (from default config):");
    print("  print(message)                 Print to console and log");
    print("");
    print("===============================================================================");
    print("CONTEXT OBJECT (for action functions in config.js)");
    print("===============================================================================");
    print("");
    print("Action functions receive a context object:");
    print("");
